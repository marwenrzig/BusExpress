                    ...
                    <div class="table-responsive--sm table-responsive">
                        <table class="table table--light style--two">
                            ...
                            @forelse($schedules as $item)
                                @php
                                    $start   = Carbon\Carbon::parse($item->depart);
                                    $end    = Carbon\Carbon::parse($item->arrive);
                                    $diff   = $start->diff($end);
                                @endphp
                                <tr>
                                    <td data-label="@lang('Start From')">
                                        {{ showDateTime($item->depart, 'h:i a') }}
                                    </td>
                                    <td data-label="@lang('End At')">
                                        {{ showDateTime($item->arrive, 'h:i a') }}
                                    </td>
                                    ...
                                    <td data-label="@lang('Action')">
                                        <button type="button" class="icon-btn ml-1 editBtn"
                                                ...
                                                data-depart="{{ showDateTime($item->depart, 'H:i') }}"
                                                data-arrive ="{{ showDateTime($item->arrive, 'H:i') }}"
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <div class="input-group clockpicker">
                                <input type="text" class="form-control" placeholder="--:--" name="depart" autocomplete="off" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group clockpicker">
                                <input type="text" class="form-control" placeholder="--:--" name="arrive" autocomplete="off" required>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        (function ($) {
            ...
            $('.editBtn').on('click', function () {
                ...
                modal.find('input[name=depart]').val($(this).data('depart'));
                modal.find('input[name=arrive]').val($(this).data('arrive'));
                modal.modal('show');
            });
