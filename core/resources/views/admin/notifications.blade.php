...
@section('panel')
    <div class="notify__area">
        ...
        <a class="notify__item @if($notification->lire_status == 0) unread--notification @endif" href="{{ route('admin.notification.read',$notification->id) }}">
            ...
            <div class="notify__content">
                <h6 class="title">{{ __($notification->titre) }}</h6>
