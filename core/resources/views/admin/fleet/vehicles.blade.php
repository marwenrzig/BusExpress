                ...
                <form action="{{ route('admin.fleet.vehicles.store')}}" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="@lang('Enter nick name')" name="label" required>
                        </div>
                        <div class="form-group">
                            ...
                            <select name="fleet_type" class="form-control">
                                ...
                                @foreach ($fleetType as $item)
                                    <option value="{{ $item->id }}">{{ __($item->nom) }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group">
                            <label class="form-control-label font-weight-bold"> @lang('Chasis No.')</label>
                            <input type="text" class="form-control" placeholder="@lang('Chasis No.')" name="register_no" required>
                        </div>
                    </div>
            ...
            <div class="modal-content">
                ...
                <form action="" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label class="form-control-label font-weight-bold"> @lang('Chasis No.')</label>
                            <input type="text" class="form-control" placeholder="@lang('Enter Chasis No.')" name="register_no" required>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn--dark" data-dismiss="modal">@lang('Close')</button>
...
<script>
    (function ($) {
        ...
        $('.disableBtn').on('click', function () {
            ...
            modal.find('.nick_name').text($(this).data('label') + "(" + $(this).data('register_no') + ")");
            modal.modal('show');
        });
        ...
        $('.editBtn').on('click', function () {
            ...
            modal.find('input[name=label]').val(vehicle.label);
