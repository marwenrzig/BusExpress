                                ...
                                <div class="row gy-3 p-4">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-contorl form--control radius-0" id="InputFirstname" name="prenom" placeholder="@lang('First Name')" value="{{$user->prenom}}" minlength="3">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="nom" class="form-label">@lang('Last Name')</label>
                                            <input type="text" class="form-contorl form--control radius-0" id="nom" name="nom" placeholder="@lang('Last Name')" value="{{$user->nom}}" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
