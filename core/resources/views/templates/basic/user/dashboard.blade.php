                ...
                <table class="booking-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="" data-label="@lang('AC / Non-Ac')">{{ $item->trip->fleetType->est_climatise ? 'AC' : 'Non-Ac' }}</td>
                            <td class="pickup" data-label="Starting Point">{{ __($item->pickup->nom) }}</td>
                            <td class="drop" data-label="Dropping Point">{{ __($item->drop->nom) }}</td>
                            <td class="date" data-label="Journey Date">{{ __(showDateTime($item->date_of_journey , 'd M, Y')) }}</td>
                            <td class="time" data-label="Pickup Time">{{ __(showDateTime($item->trip->schedule->depart, 'H:i a')) }}</td>
