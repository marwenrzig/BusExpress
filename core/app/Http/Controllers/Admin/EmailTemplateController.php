...
class EmailTemplateController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $email_template = EmailTemplate::findOrFail($id);
        $email_template->subj = $request->sujet;
    ...
    public function emailTemplateUpdate(Request $request)
    {
        ...
        $general = GeneralSetting::first();
        $general->email_de  = $request->email_de ;
    ...
    public function sendTestMail(Request $request)
    {
        ...
        $sujet = 'Testing ' . strtoupper($config->name) . ' Mail';
        $message = 'This is a test email, please ignore it if you are not meant to get this email.';

        try {
            sendGeneralEmail($request->email, $sujet, $message, $receiver_name);
        } catch (\Exception $exp) {
