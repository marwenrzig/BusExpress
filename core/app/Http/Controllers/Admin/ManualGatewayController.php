...
class ManualGatewayController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('image')) {
            try {
                ...
                $notify[] = ['error', 'L’image n’a pas pu être téléchargée.'];
        ...
        $notify[] = ['success', $method->name . '  Une moyen manuelle a été ajoutée.'];
        return back()->withNotify($notify);
    }
    ...
    public function update(Request $request, $code)
    {
        ...
        $notify[] = ['success', $method->name . ' La moyen manuelle a été mise à jour.'];
    ...
    public function activate(Request $request)
    {
        ...
        $method->status = 1;
        $method->save();
        $notify[] = ['success', $method->name . ' a été actif.'];
        return back()->withNotify($notify);
    }
    ...
    public function deactivate(Request $request)
    {
        ...
        $method->status = 0;
        $method->save();
        $notify[] = ['success', $method->name . ' a été désactivé.'];
        return back()->withNotify($notify);
    }
}
